    ...
    <MDBFooter color="blue-grey" className="page-footer font-small lighten-5 pt-0">
      ...
      <MDBContainer className="mt-5 mb-4 text-center text-md-left">
        <MDBRow className="mt-3">
          ...
          <MDBCol md="4" lg="3" xl="3" className="mb-4 dark-grey-text">
            ...
            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
            <p>
              <i className="fa fa-home mr-3" /> Abohar, Punjab 152116, India
            </p>
            <p>
              <i className="fa fa-envelope mr-3" /> shivamaggarwal2042001@gmail.com
            </p>
            <p>
      ...
      <div className="footer-copyright text-center py-3">
        <MDBContainer fluid>
          ...
          <Link to="https://github.com/shsarv"> https://www.linkedin.com/in/shivam-goyal-427b431b1/</Link>
        </MDBContainer>
      </div>
    </MDBFooter>
  );
